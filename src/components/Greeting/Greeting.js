...
const Greeting = (props) => {
  ...
  const searchArtists = async (e) => {
    ...
    return ( 
      ...
      <Button onClick={props.onDisplayResults} type="submit" style={{fontSize: '1rem', fontWeight: '700', fontSize: '1rem', border: '0', borderRadius: '0', background: '#ff3366', padding: '16px 40px', color: 'White' }}>
        SEARCH
      </Button>
    </Form>
    </div>
